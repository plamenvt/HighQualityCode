namespace CohesionAndCoupling
{
    ...
    internal class UtilsExamples
    {
        private static void Main()
        {
            ...
            Console.WriteLine("Distance in the 2D space = {0:f2}", CalculateDistanceUtils.CalculateDistance2D(1, -2, 3, 4));
            Console.WriteLine("Distance in the 3D space = {0:f2}", CalculateDistanceUtils.CalculateDistance3D(5, 2, -1, 3, -6, 4));
